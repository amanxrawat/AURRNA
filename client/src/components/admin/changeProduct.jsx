...
export default function ChangeProductForm() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-4 bg-gradient-to-tr from-purple-900 to-purple-700 text-white">
      <h1 className="text-3xl font-bold mb-8 flex items-center justify-center uppercase">Change Prodcut Information</h1>
